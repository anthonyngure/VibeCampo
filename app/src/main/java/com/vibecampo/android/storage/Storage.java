...
import com.vibecampo.android.storage.SimpleStorage.StorageType;
...
public interface Storage {
     ...
     * @return <code>True</code> if directory was isCreated, otherwise return
     * <code>False</code>
     ...
     * directory will be isCreated instead. <br>
     * <br>
     * <p>
     ...
     */
    FileCreate createFile(String directoryName, String fileName, String content);
     ...
     */
    FileCreate createFile(String directoryName, String fileName, Storable storable);
     ...
     */
    FileCreate createFile(String directoryName, String fileName, Bitmap bitmap,
     ...
     * @param content       The content which will filled the file
     */
    FileCreate createFile(String directoryName, String fileName, byte[] content);
